...
const courses = [
    ...
    { code: "345", row: 5, column: 5, name: "무기화학Ⅱ", startCourseId: "16116", prereqs: ["344"] },
    ...
    { code: "438", row: 5, column: 3, name: "유기반응 및 합성화학", startCourseId: "1475", prereqs: ["223"] },
    ...
    { code: "453", row: 3, column: 3, name: "인공지능 화학", startCourseId: "23351", prereqs: ["211", "213", "223 Left Right"] },
