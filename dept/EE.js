...
const courses = [
    ...
    { code: "326", row: 5, column: 6, name: "정보이론 및 부호화 개론", startCourseId: "800", prereqs: ["210"], refs: ["321"] },
    ...
    { code: "412", row: 3, column: 6, name: "빅데이터 분석 개론", startCourseId: "4837" },
    { code: "414", row: 3, column: 7, name: "임베디드시스템", startCourseId: "1994", prereqs: ["303"], prereqs: ["303", "312", "323"] },
    { code: "415", row: 3, column: 8, name: "전자공학을 위한 운영체제 및 시스템 프로그래밍", startCourseId: "824", prereqs: ["312 Right Left"] },
    ...
    { code: "477", row: 6, column: 6, name: "데이터베이스 및 빅데이터 시스템", startCourseId: "23507" },
    { code: "478", row: 6, column: 7, name: "융합적 로봇공학 개론", startCourseId: "23578" },
